...
divp1.setAttribute("id" , "buttons");
divp1.setAttribute("class","d-flex justify-content-center")
document.body.append(divp1);
...
if (state.page != 1 ) {
    wrapper.innerHTML = `<button value=${1} class="page btn btn-sm btn-warning">First</button>` + wrapper.innerHTML
}
if (state.page != pages) {
